...
for population_size in populations:
    functions[population_size] = get_f(os.path.join(test, f"functions/synchronous_{population_size}_bees.txt"), "prism", True)
...
results_folder = os.path.join(test, "results")
try:
    results = pickle_load(os.path.join(results_folder, "results.p"))
    coverages = pickle_load(os.path.join(results_folder, "coverages.p"))
    averages_and_deviations = pickle_load(os.path.join(results_folder, "averages_and_deviations.p"))
except:
    results = {}
    coverages = {}
                        ...
                        for method in methods:
                            for v_p in p_values:
                                for v_q in q_values:
                                    ...
                                    pickle_dump(results, os.path.join(results_folder, "results.p"))
                                    pickle_dump(coverages, os.path.join(results_folder, "coverages.p"))
                                    pickle_dump(averages_and_deviations, os.path.join(results_folder, "averages_and_deviations.p"))
