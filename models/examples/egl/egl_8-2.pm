...
const double p;
const int N = 8; // number of pairs of secrets the party sends
...
module partyA
	...
	[receiveA] phase=1 & n=5  -> p : (b5'=L)  + (1-p) : (b25'=L);
	[receiveA] phase=1 & n=6  -> p : (b6'=L)  + (1-p) : (b26'=L);
	[receiveA] phase=1 & n=7  -> p : (b7'=L)  + (1-p) : (b27'=L);
...
module partyB=partyA[b0 =a0 ,b1 =a1 ,b2 =a2 ,b3 =a3 ,b4 =a4 ,b5 =a5 ,b6 =a6 ,b7 =a7 ,
