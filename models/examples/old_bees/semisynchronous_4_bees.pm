...
module two_param_agents_4
       ...
       []   a0 = 1 & a1 = 2 & a2 = 2 & a3 = 2 -> q:(a0'= 1) & (a1'= 1) & (a2'= 2) & (a3'= 2) + 1-q:(a0'= 1) & (a1'= 2) & (a2'= 2) & (a3'= 0);
       []   a0 = 1 & a1 = 1 & a2 = 2 & a3 = 2 -> q:(a0'= 1) & (a1'= 1) & (a2'= 1) & (a3'= 2) + 1-q:(a0'= 1) & (a1'= 1) & (a2'= 2) & (a3'= 0);
       []   a0 = 1 & a1 = 1 & a2 = 1 & a3 = 2 -> q:(a0'= 1) & (a1'= 1) & (a2'= 1) & (a3'= 1) + 1-q:(a0'= 1) & (a1'= 1) & (a2'= 1) & (a3'= 0);

       // some ones, some twos, some zeros transitions
       []   a0 = 1 & a1 = 2 & a2 = 0 & a3 = 0 -> q: (a0' = 1) & (a1'= 1) & (a2'= 0) & (a3'= 0) + 1-q: (a0' = 1) & (a1'= 0) & (a2'= 0) & (a3'= 0);
       []   a0 = 1 & a1 = 2 & a2 = 2 & a3 = 0 -> q: (a0' = 1) & (a1'= 1) & (a2'= 2) & (a3'= 0) + 1-q: (a0' = 1) & (a1'= 2) & (a2'= 0) & (a3'= 0);
       []   a0 = 1 & a1 = 1 & a2 = 2 & a3 = 0 -> q: (a0' = 1) & (a1'= 1) & (a2'= 1) & (a3'= 0) + 1-q: (a0' = 1) & (a1'= 1) & (a2'= 0) & (a3'= 0);
